...
Gen_Cert(){
    Echo_c "生成/data/data/com.termux/files/home/.rnd随机文件"
    openssl rand -writerand /data/data/com.termux/files/home/.rnd
    Echo_c "生成随机名称"
    rndca=$(Rand_Name)
    rndserver=$(Rand_Name)
    rndclient=$(Rand_Name)
...
ssl_client_certificate /data/data/com.termux/files/home/viper/Docker/nginxconfig/ca.crt;
